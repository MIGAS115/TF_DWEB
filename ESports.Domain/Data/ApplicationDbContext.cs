...
namespace ESports.Domain.Data
{
    ...
    public class ApplicationDbContext : IdentityDbContext<MyUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<TournamentTeam>().ToTable("TorneioEquipa");
            builder.Entity<Favorite>().ToTable("Favoritos");
            builder.Entity<ESports.Domain.Models.Match>().ToTable("Partida");
            builder.Entity<Team>().ToTable("Equipa");
            builder.Entity<Tournament>().ToTable("Torneio");
            builder.Entity<Normal>().ToTable("Normal");
